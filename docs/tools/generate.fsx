...
let website = "/Angara.Table"

let githubLink = "http://github.com/Microsoft/Angara.Table"

// Specify more information about your project
let info =
  [ "project-name", "Angara.Table"
    "project-author", "Microsoft Research"
    "project-summary", "A .NET library to work with table data type."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Angara.Table" ]
